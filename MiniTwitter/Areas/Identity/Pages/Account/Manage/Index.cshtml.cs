...
namespace MiniTwitter.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(TwitterUser twitterUser)
        {
            var userName = await _userManager.GetUserNameAsync(twitterUser);
            var phoneNumber = await _userManager.GetPhoneNumberAsync(twitterUser);
